pipeline {
  ...
  environment {
    ...
    EXT_REPO = 'pelorus'
    BUILD_VERSION_ARG = 'PELORUS_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-pelorus'
    CONTAINER_NAME = 'pelorus'
    DOCKERHUB_IMAGE = 'linuxserver/pelorus'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/pelorus'
    PR_DOCKERHUB_IMAGE = 'lspipepr/pelorus'
    DIST_IMAGE = 'arch'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-pelorus/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-pelorus\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-pelorus\" \
